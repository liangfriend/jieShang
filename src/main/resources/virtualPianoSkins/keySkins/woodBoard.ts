...
const WOOD_WHITE: KeySkinSvg = {
  ...
  <path d="M0 91 H20 V98.25 Q20 100 17 100 H3 Q0 100 0 98.25 Z" fill="url(#wdWnFront)"/>
  <rect x="0" y="91" width="1.3" height="9" fill="url(#wdWnEdgeL)"/>
  <rect x="18.7" y="91" width="1.3" height="9" fill="url(#wdWnEdgeR)"/>
  <rect x="0" y="0" width="20" height="91" fill="url(#wdWnBase)"/>
  <rect x="0" y="0" width="20" height="91" filter="url(#wdWnBlotch)"/>
  <rect x="0" y="0" width="20" height="91" filter="url(#wdWnGrain)"/>
  ...
  <rect x="0" y="0" width="1.6" height="91" fill="rgba(40,22,8,0.28)"/>
  <rect x="18.4" y="0" width="1.6" height="91" fill="rgba(40,22,8,0.34)"/>
  <line x1="20" y1="0" x2="20" y2="100" stroke="rgba(40,22,8,0.35)" stroke-width="0.5"/>
  <line x1="0" y1="91" x2="20" y2="91" stroke="rgba(40,22,8,0.25)" stroke-width="0.5"/>`
  ),
  ...
  <path d="M0 93.5 H20 V98.25 Q20 100 17 100 H3 Q0 100 0 98.25 Z" fill="url(#wdWpFront)"/>
  <rect x="0" y="93.5" width="1.3" height="6.5" fill="url(#wdWpEdgeL)"/>
  <rect x="18.7" y="93.5" width="1.3" height="6.5" fill="url(#wdWpEdgeR)"/>
  <rect x="0" y="0" width="20" height="93.5" fill="url(#wdWpBase)"/>
  <rect x="0" y="0" width="20" height="93.5" filter="url(#wdWpGrain)"/>
  ...
  <rect x="0" y="0" width="1.6" height="93.5" fill="rgba(30,16,6,0.3)"/>
  <rect x="18.4" y="0" width="1.6" height="93.5" fill="rgba(30,16,6,0.36)"/>
  <rect x="0" y="90.5" width="20" height="3" fill="rgba(20,10,4,0.2)"/>
  <line x1="20" y1="0" x2="20" y2="100" stroke="rgba(30,16,6,0.4)" stroke-width="0.5"/>
  <line x1="0" y1="93.5" x2="20" y2="93.5" stroke="rgba(30,16,6,0.3)" stroke-width="0.5"/>`
  )
}
...
const WOOD_BLACK: KeySkinSvg = {
  ...
  <g filter="url(#wdBnShadow)">
    <path d="M0 53 H12 V58.5 Q12 59.5 10 59.5 H2 Q0 59.5 0 58.5 Z" fill="url(#wdBnFront)"/>
    <path d="M0 53 H12 V58.5 Q12 59.5 10 59.5 H2 Q0 59.5 0 58.5 Z" filter="url(#wdBnBark)"/>
    <rect x="0" y="53" width="0.9" height="6.5" fill="url(#wdBnEdgeL)"/>
    <rect x="11.1" y="53" width="0.9" height="6.5" fill="url(#wdBnEdgeR)"/>
    <rect x="0" y="0" width="12" height="53" fill="url(#wdBnTop)"/>
    <rect x="0" y="0" width="12" height="53" filter="url(#wdBnRough)"/>
    ${WOOD_END_RINGS}
    ...
    <line x1="0" y1="53" x2="12" y2="53" stroke="rgba(20,10,4,0.4)" stroke-width="0.4"/>
  </g>`
  ),
  press: wrapKeySkinSvg(
    '0 0 12 60',
  ...
  <path d="M0 56 H12 V58.5 Q12 59.5 10 59.5 H2 Q0 59.5 0 58.5 Z" fill="url(#wdBpFront)"/>
  <rect x="0" y="56" width="0.9" height="3.75" fill="url(#wdBpEdgeL)"/>
  <rect x="11.1" y="56" width="0.9" height="3.75" fill="url(#wdBpEdgeR)"/>
  <rect x="0" y="0" width="12" height="56" fill="url(#wdBpTop)"/>
  <rect x="0" y="0" width="12" height="56" filter="url(#wdBpRough)"/>
  ...
  <rect x="0" y="53.5" width="12" height="2.5" fill="rgba(15,8,3,0.3)"/>
  <line x1="0" y1="56" x2="12" y2="56" stroke="rgba(15,8,3,0.55)" stroke-width="0.55"/>`
  )
}
