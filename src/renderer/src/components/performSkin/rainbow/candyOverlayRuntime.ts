...
import { createCandyBurstRuntime } from '../canvas/candyBurstEffect'

export function createRainbowCandyOverlayRuntime(): PerformOverlayRuntime {
  const burst = createCandyBurstRuntime()
